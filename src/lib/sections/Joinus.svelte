    ...
    >
      ...
      <div class="join_section__text">
        <p class="max-w-xl text-base md:text-xl">
          ...
          of decentralized and democratic media, and pave the way for a
          brighter, more engaging future. Connect with us today and embark on a
          transformative journey with Mindplex.
        </p>
      </div>
    </div>
