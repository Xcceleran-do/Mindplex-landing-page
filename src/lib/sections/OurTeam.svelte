  ...
  >
        ...
        { #each ourTeam as {name, position, imageUrl, socialLink, customImageStyle} } 
          <div class="relative flex flex-col items-center team-card  md:w-84 xl:w-96 h-72 transition-all ease-in-out duration-300">
            ...
            <div class="bottom-0 absolute backdrop-blur-xlll rounded-2xl h-[86px] w-full transition-all ease-in-out duration-300">
              <div class="p-6 text-black">
                <p class="name text-xl text-black font-semibold">{name}</p>
                <p class="position text-xs text-black font-normal mt-2">
                  {position}
                </p>
                <div class="mt-3">
...
<style>
  ...
  .team-card:hover .backdrop-blur-xlll {
    height: 80%;
  }
</style>
