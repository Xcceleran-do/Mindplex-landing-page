    ...
    {#each ourAi as { title, image,description}}
          ...
          <div class="card cursor-pointer transition-all ease-in-out duration-300 bg-black bg-opacity-25 rounded-3xl flex justify-center items-center relative max-w-sm min-h-[24rem]">
            ...
            <div class="card-heading flex justify-center items-center z-50">
              <h2 class=" text-3xl font-bold uppercase mb-4 w-fit text-center ">
                {title}
              </h2>
            </div>
            <div class="card-description text-white opacity-0  transition-opacity duration-300 ease-in-out absolute bottom-5 left-5 right-5">
              <h2 class="text-xl mx-auto font-bold uppercase mb-4 w-fit text-center ">
                {title}
              </h2>
              <hr class="w-1/2 mx-auto mb-4 bg-[#B7E8E5]" />
