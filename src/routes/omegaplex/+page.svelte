<script lang="ts">
	import OmegaPlexHero from '$lib/section/OmegaPlexHero.svelte';
...
<Seo
	title="OmegaPlex | An AI newsroom that reasons before it writes"
	description="OmegaPlex watches one beat continuously: discovering signals, remembering what happened before, reasoning symbolically, and checking every source. A human editor decides what gets published."
/>
